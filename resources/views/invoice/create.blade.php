...
@section('title', 'customer create form')
@section('content-head', 'Create Invoice')
...
@section('content')
    ...
    @endif
    {!! Form::open(['route'=>'invoices.store', 'files'=>true,'class'=>'form-horizontal ']) !!}
    <table  class="table table-responsive mt-2 bordered-0 " >
        <tr>
            <td>
                {{Form::select('customer_id', $customers, null, array('class'=>'form-control customer_id','id'=>'selector3' ) )}}
            </td>
            <td>
                {{Form::text('invoice_date', '', array('class'=>'form-control item_price','id'=>'datepicker','readonly','placeholder'=>'yyyy-mm-dd' ) )}}

            </td>
            <td>
                {{Form::text('invoice_no', $invoice_no, array('class'=>'form-control item_price' ) )}}
            </td>
        </tr>
        <tr>
            <td>
